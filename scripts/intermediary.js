...
async function initializeIntermediaryDropdown() {
    ...
    const codeInputContainer = document.getElementById('IntermediaryCode').parentNode;
    const nameInput = document.getElementById('IntermediaryName');
    const emailInput = document.getElementById('Intermediaryemail');
    
    // Remove the original input field
    const originalInput = document.getElementById('IntermediaryCode');
    codeInputContainer.removeChild(originalInput);
    
    // Create a select dropdown instead
    const selectDropdown = document.createElement('select');
    selectDropdown.id = 'IntermediaryCode';
...
document.addEventListener('DOMContentLoaded', function() {
    initializeIntermediaryDropdown();
});